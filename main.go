...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{
		r.Training.TrainingType,
		r.Training.Duration,
		r.Training.distance(),
		r.Training.meanSpeed(),
		r.Training.Calories(),
	}
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(w.Training.meanSpeed()/3.6, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinsInHour)
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return float64(s.LengthPool * s.CountPool / MInKm / int(s.Training.Duration.Hours()))
}
